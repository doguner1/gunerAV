            ...
            <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 p-6 sm:p-8 shadow-sm dark:shadow-2xl space-y-6">
              ...
              <div className="space-y-4 border-t border-neutral-100 dark:border-neutral-900 pt-4 text-xs">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-bold text-neutral-700 dark:text-neutral-300">Adres:</span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-bold text-neutral-700 dark:text-neutral-300">Çalışma Saatleri:</span>
                    <p className="mt-0.5 text-neutral-700 dark:text-neutral-400 font-medium">Hafta İçi &amp; Cumartesi: 08:30 - 20:00</p>
                    <p className="text-neutral-700 dark:text-neutral-400 font-medium">Pazar: 10:00 - 18:00</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="font-bold text-neutral-700 dark:text-neutral-300">Telefon:</span>
                    <a
                      href={`tel:${STORE_INFO.phone}`}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="font-bold text-neutral-700 dark:text-neutral-300">E-Posta:</span>
                    <a
