...
export default function FeaturedCategories({ products = [] }: { products?: Product[] }) {
  ...
  return (
    <section id="categories" className="border-b border-neutral-200/80 dark:border-neutral-800/80 bg-white dark:bg-black pt-8 pb-16 sm:pt-14 sm:pb-20 lg:py-20 transition-colors scroll-mt-16">
