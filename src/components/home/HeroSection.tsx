...
export default function HeroSection({ products = [] }: { products?: Product[] }) {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden border-b border-neutral-800 bg-neutral-950 pt-20 pb-16 lg:py-24">
      ...
      {/* Subtle Golden Tactical Ambient Lighting on the right */}
      <div className="absolute right-10 top-1/4 z-0 h-[450px] w-[450px] rounded-full bg-[#d4af37]/15 blur-[130px] pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          {/* RIGHT COLUMN: Fully Transparent Frosted Glass Spotlight Card */}
          <div className="lg:col-span-5 relative mt-4 lg:mt-0">
            {/* Luminous Glass Outer Border */}
            <div className="relative rounded-3xl p-[1px] bg-gradient-to-b from-[#d4af37]/60 via-white/20 to-[#d4af37]/30 shadow-[0_20px_50px_rgba(0,0,0,0.6)] backdrop-blur-xl">
              {/* Semi-Transparent Frosted Glass Container (Background Visible Through It) */}
              <div className="relative rounded-[23px] bg-neutral-950/40 backdrop-blur-xl border border-white/15 p-5 sm:p-6 pb-12 sm:pb-14 overflow-hidden text-white shadow-2xl">
                ...
                <div className="flex items-center justify-between gap-2 pb-4 border-b border-white/10">
                  ...
                  <div className="flex items-center gap-1.5 rounded-full bg-emerald-500/20 px-2.5 py-0.5 text-[10px] font-bold text-emerald-400 border border-emerald-500/30">
                ...
                <Link
                  ...
                  className="group block relative my-4 rounded-2xl bg-black/40 border border-white/15 overflow-hidden aspect-[4/3] backdrop-blur-md shadow-inner"
                >
                  <Image
                    src={spotlightImage}
                    alt={spotlightTitle}
                ...
                {/* Tactical Specs Bar (Translucent Glass Pills) */}
                <div className="grid grid-cols-3 gap-2.5 py-3 border-y border-white/10 text-center">
                  <div className="rounded-xl bg-white/[0.08] backdrop-blur-md border border-white/10 p-2.5">
                  ...
                  <div className="rounded-xl bg-white/[0.08] backdrop-blur-md border border-white/10 p-2.5">
                    ...
                    <div className="font-heading font-black text-sm text-emerald-400 mt-0.5">
                      %92+
                    </div>
                  </div>
                  <div className="rounded-xl bg-white/[0.08] backdrop-blur-md border border-white/10 p-2.5">
                ...
                <div className="flex items-center justify-between pt-4 gap-3">
                  <div className="flex flex-col space-y-0.5">
                    <span className="text-[11px] uppercase tracking-wider font-bold text-amber-300/90 flex items-center gap-1">
                  ...
                  <Link
                    href={featuredProductSlug}
                    className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-amber-400 via-[#d4af37] to-amber-500 hover:brightness-110 px-5 py-3 text-xs font-black uppercase tracking-wider text-black shadow-lg transition-all hover:scale-[1.03] active:scale-95 shrink-0"
                  >
            ...
            {/* Floating Trust Indicator Pill on Desktop (Frosted Glass) */}
            <div className="hidden sm:flex items-center gap-3 absolute -bottom-5 -left-6 rounded-2xl border border-white/20 bg-neutral-950/85 px-4 py-2.5 shadow-2xl backdrop-blur-xl text-white">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#d4af37]/20 border border-[#d4af37]/30 text-[#d4af37] font-bold shrink-0">
