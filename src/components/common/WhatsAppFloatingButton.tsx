  ...
  return (
    <aside aria-label="WhatsApp Canlı Destek" className="fixed bottom-6 right-6 z-40">
      ...
      >
        ...
        {/* Hover Tooltip */}
        <span className="pointer-events-none absolute right-full mr-3 hidden whitespace-nowrap rounded-lg border border-neutral-800 bg-neutral-900/95 px-3 py-1.5 text-xs font-semibold text-white shadow-xl backdrop-blur-md md:group-hover:block">
          WhatsApp'tan Yazın
        </span>
      </a>
    </aside>
